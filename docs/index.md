...
The [OSTree related projects] section covers this to a degree. As soon as one
starts taking "snapshots" or keeping track of multiple roots, it uncovers many
issues. For example, which content specifically is rolled forward or backwards?
If the package manager isn't deeply aware of a snapshot tool, it's easy to lose
coherency.
...
[OSTree related projects]: https://ostreedev.github.io/ostree/related-projects/
